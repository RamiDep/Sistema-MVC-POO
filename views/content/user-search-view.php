...
<!-- video 47-->
<?php
if (!isset($_SESSION['search_users']) && empty($_SESSION['search_users'])){
?>
                ...
                <div class="row justify-content-md-center">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="search_object" id="inputSearch_user" maxlength="30">
                        </div>
                    </div>
                    <div class="col-12">
...
?>
                ...
                <div class="row justify-content-md-center">
                    <div class="col-12 col-md-6">
                        <p class="text-center" style="font-size: 20px;">
                            Resultados de la busqueda <strong>“<?php echo $_SESSION['search_users'] ?>”</strong>
                        </p>
                    </div>
                    <div class="col-12">
    ...
    <div class="container-fluid">
        <?php /* Video 47  */
            ...
            echo $object_user->pager_controller($page[1], 15, $_SESSION['id_itm'], $_SESSION['privile_itm'], $page[0], $_SESSION['search_users']);
        ?>
    </div>
